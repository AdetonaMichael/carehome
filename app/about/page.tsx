    ...
    <div className="w-full">
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#f0f9fc] to-white border border-[#c8e7f0] rounded-2xl p-10 space-y-6 text-slate-700 text-base leading-relaxed shadow-sm">
            <p>
            ...
            <p>
              A fall that occurs at night gets documented hours later. Training gets entered manually into three separate systems. Inspection preparation becomes a week of manual file organization.
            </p>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-white rounded-lg p-8 space-y-4 text-left max-w-2xl mx-auto">
            <div className="flex gap-4">
              <div className="w-12 h-12 bg-[#77bdda] rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">1</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="w-12 h-12 bg-[#77bdda] rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">2</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="w-12 h-12 bg-[#77bdda] rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">3</div>
              <div>
      ...
      <Section
        id="cta"
        className="bg-gradient-to-br from-[#77bdda] to-[#5a9bb3] text-white text-center"
      >
        <div className="max-w-2xl mx-auto">
          ...
          <a
            href="/contact"
            className="inline-block bg-white text-[#77bdda] px-8 py-3 rounded-lg font-semibold hover:bg-[#f0f9fc] transition-colors"
          >
            Get in Touch
          </a>
        </div>
